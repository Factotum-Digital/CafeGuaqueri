...
export const COFFEE_PRODUCTS: CoffeeItem[] = [
  {
    ...
    origin: 'Estado Sucre, Venezuela',
    description: 'Un lote lavado excepcional que exhibe la brillante acidez y las notas florales tradicionales del macizo de Sucre. Cultivado bajo un dosel de árboles nativos, recolectado a mano en su punto óptimo de madurez y lavado dos veces con agua pura de manantial de montaña.',
    price: 32.00,
    rating: 5,
  ...
  },
  {
    id: 'caripe-natural',
    name: 'Caripe Natural',
    origin: 'Estado Monagas, Venezuela',
    description: 'Proveniente de los suelos calcáreos de Caripe del Guácharo, este lote de proceso natural se seca lentamente en camas africanas elevadas durante 24 días. Frutas maduras amieladas, cuerpo denso y notas profundas de chocolate negro con un persistente toque de melaza.',
    price: 38.00,
    rating: 4.5,
  ...
  },
  {
    ...
    origin: 'Mezcla de la Casa Insignia',
    description: 'Nuestra mezcla estrella del estudio, que combina cuidadosamente la acidez estructurada del café lavado Cumanacoa con la densidad aterciopelada del Caripe natural. Diseñada para ofrecer una expresión equilibrada en cadena que representa la fuerza del Oriente de Venezuela.',
    price: 28.00,
    rating: 5,
  ...
  },
  {
    id: 'el-morro-honey',
    name: 'El Morro Honey',
    origin: 'Microlote de la Cordillera de la Costa',
    description: 'Un microlote extremadamente raro cultivado donde la brisa del Caribe acaricia las montañas costeras. Despulpado conservando el 50% de su mucílago y secado en la niebla de la montaña, lo que le otorga una claridad increíble similar al té y un perfil exótico de frutas de hueso.',
    price: 45.00,
    rating: 5,
...
export const VERIFIABLE_BLOCKS: VerifiableBlock[] = [
  {
    ...
    lotId: 'SUC-CUM-33',
    originState: 'Estado Sucre, Venezuela',
    farmerName: 'Don Lorenzo Marcano',
    altitude: '1,450m',
    fairTradePremium: '+38% Pago Directo sobre Estándar Orgánico',
    roastDate: '2026-05-24',
    moistureLevel: '10.8%',
    qualityScore: '88.5 ptos SCAA',
    hash: '0x8f3c7ea1a600bc56b0d9990f11ac88eedaa9f001b6c77bb8bfb51aaa041ffff'
  },
  {
    blockNumber: 'GQR-2024-V2',
    lotId: 'MON-CAR-18',
    originState: 'Estado Monagas, Venezuela',
    farmerName: 'Familia Salazar',
    altitude: '1,320m',
    fairTradePremium: '+35% Pago Directo sobre Estándar Orgánico',
    roastDate: '2026-05-22',
    moistureLevel: '11.1%',
    qualityScore: '86.5 ptos SCAA',
    hash: '0x7e2db0812af1100bc1bcdc4745aa00bffe0e88ba201ab03924f78aaabf49ffe1'
  },
  {
    blockNumber: 'GQR-2024-V1',
    lotId: 'CAR-HOS-09',
    originState: 'Multi-Lote Andes Marítimos',
    farmerName: 'Pacto Productores d\'Oriente',
    altitude: '1,400m promedio',
    fairTradePremium: '+30% Recompensa Directa al Productor',
    roastDate: '2026-05-20',
    moistureLevel: '10.9%',
    qualityScore: '85.5 ptos SCAA',
    hash: '0x9a4bcd12fee0e88ba924fa001bbcdc4745ab00bffe201ab039abcdc8824f7fff9'
  },
  {
    blockNumber: 'GQR-2024-V4',
    lotId: 'SUC-MOR-55',
    originState: 'Altos del Morro, Cordillera de la Costa',
    farmerName: 'Sobeida Rangel',
    altitude: '1,560m',
    fairTradePremium: '+45% Pago Directo de Microlote Sovereign',
    roastDate: '2026-05-25',
    moistureLevel: '10.5%',
    qualityScore: '89.5 ptos SCAA',
